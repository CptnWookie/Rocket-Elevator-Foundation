...
### The 3 new implementations of the unit test of the existing code can be found here : [Existing Code Tests](https://github.com/CptnWookie/Rocket-Elevator-Foundation/tree/master/spec/models)
